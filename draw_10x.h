...
void draw_fragments(int const read_size = 150, int insert_size = 400, int gen_coverage = 50, float frag_coverage = 0.2, int frag_size_min = 20000, int frag_size_max = 50000, float redundance = 4, std::string fileGenome = "tests/genome.fasta", std::string fileReads = "tests/reads.fasta");

...
void cluster_graph(robin_hood::unordered_map<long int, std::list<int>> &matching_tags, std::vector<int> &clusters);
void cluster_graph_chinese_whispers(robin_hood::unordered_map<long int, std::set<int>> &matching_tags, std::vector<int> &clusters);

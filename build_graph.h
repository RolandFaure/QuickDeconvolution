...
void thread_deconvolve(short minCommonKmers, robin_hood::unordered_map <std::string, long int> &tagIDs, const std::vector <std::vector<long long int>> &readClouds, const std::vector <Read> &reads, const std::vector<std::vector<long int>> &kmers, int thread_id, int num_thread, std::string folderOut);
